        ...
        <div className="flex flex-wrap items-end justify-between gap-3">
          <div>
            ...
            <p className="mt-1 max-w-2xl text-[13px] leading-5 text-muted-foreground">
              Les appels passent par l’application web Onoff ou son extension Click2Call. Gando utilise l’API Onoff côté serveur pour vérifier et enrichir les appels, puis les webhooks mettent à jour le workflow commercial.
            </p>
          </div>
          <div className="flex flex-wrap gap-2">
            <Badge variant={onoff?.configured && onoff.connected !== false ? "default" : "outline"}>{apiLabel}</Badge>
            <Badge variant="outline">Click2Call Onoff</Badge>
          </div>
        </div>
