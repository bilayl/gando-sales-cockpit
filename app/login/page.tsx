          ...
          <CardContent className="space-y-4">
            ...
            {oauthReady ? (
              ...
              <div className="rounded-xl border border-amber-400/30 bg-amber-400/10 px-4 py-3 text-sm text-amber-200">
                Configurez <code>HUBSPOT_CLIENT_ID</code>, <code>HUBSPOT_CLIENT_SECRET</code>, <code>HUBSPOT_REDIRECT_URI</code> et <code>SESSION_SECRET</code>, ou fournissez temporairement <code>HUBSPOT_PRIVATE_APP_TOKEN</code>.
              </div>
            )}
          </CardContent>
        </Card>
