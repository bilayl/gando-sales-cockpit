...
function ClientHero({ room }: { room: PublicRoomData["room"] }) {
  ...
  return (
    <section
      className={cn(
        "relative isolate w-full overflow-hidden bg-gradient-to-br px-5 pb-12 pt-12 shadow-[0_18px_55px_rgba(84,62,177,0.14)] sm:px-10 sm:pb-14 sm:pt-14 lg:px-14",
