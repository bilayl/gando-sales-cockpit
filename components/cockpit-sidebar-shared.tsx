...
export function GandoSidebarMark() {
  return (
    <span className="grid size-8 shrink-0 place-items-center overflow-hidden rounded-lg bg-[#6f58e8] shadow-sm" aria-hidden="true">
      ...
      <SidebarMenuItem>
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            ...
            >
              ...
              <div className="grid min-w-0 flex-1 text-left leading-tight">
                <span className="truncate text-[15px] font-semibold tracking-[-0.025em]">gando</span>
                <span className="truncate text-[10px] font-medium text-sidebar-foreground/55">{section}</span>
              </div>
          ...
          <DropdownMenuContent
            ...
            sideOffset={6}
          >
            <DropdownMenuLabel className="text-xs font-medium text-muted-foreground">Espaces Gando</DropdownMenuLabel>
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem onSelect={(event) => { event.preventDefault(); toggleSidebar(); }} className="gap-2">
