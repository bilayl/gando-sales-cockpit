...
const commercialNav: NavSection[] = [
  ...
  },
  {
    label: "Préparer",
    items: [
      { href: "/ai-sales", label: "Assistant IA", icon: Bot },
...
export function AppSidebar({ email, role = "member" }: { email?: string; role?: CockpitRole }) {
  ...
  return (
    <aside className="flex h-screen w-[72px] flex-col border-r border-border bg-card px-2.5 py-4 lg:w-[216px] lg:px-3">
      <Link href="/" className="flex h-11 items-center justify-center gap-2.5 px-1 lg:justify-start lg:px-2">
        ...
        <span className="hidden min-w-0 lg:block">
          ...
          <span className="block text-[9px] font-bold uppercase tracking-[0.17em] text-muted-foreground">Cockpit · CRM</span>
        </span>
      </Link>
