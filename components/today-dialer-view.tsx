          ...
          <div className="grid min-h-[520px] gap-4 xl:grid-cols-[1fr_360px]">
                ...
                <div className="grid md:grid-cols-[1fr_310px]">
                  <div className="p-7">
                    ...
                    <div className="mt-7 flex flex-wrap gap-2">
                      <Button className="h-11 rounded-xl bg-[#1f3a31] px-5 text-white hover:bg-[#183129]" onClick={() => void openCallWorkspace()} disabled={queueing || !alloHealthy}>
                    ...
                    <p className="mt-3 max-w-2xl text-[11px] leading-5 text-[#818c86]">Le clic ouvre désormais le poste d’appel directement dans le Cockpit. Le prospect est synchronisé avec Allo avant l’ouverture de l’interface.</p>
                  </div>
            ...
            <aside className="rounded-2xl border border-[#e3e8e5] bg-white p-5">
              ...
              <div className="mt-5 space-y-4 text-[12px]">
                ...
                <div><div className="text-[#87918c]">Audio dans le Cockpit</div><div className="mt-1 font-medium">{allo?.directCallReady ? "Capacité directe détectée" : "Interface intégrée, média Allo externe pour l’instant"}</div></div>
              </div>
